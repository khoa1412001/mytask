...
public class ServiceRoutePath {
  ...
  public static final String CREATE_TASK_CHANNEL = "create.task.channel";
  public static final String EDIT_TASK_CHANNEL = "edit.task.channel";
  public static final String GET_TASK_CHANNEL = "get.task.channel";
